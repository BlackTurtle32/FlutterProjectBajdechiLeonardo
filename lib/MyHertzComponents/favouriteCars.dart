...
class FavouriteCars extends StatefulWidget {
  @override
  _FavouriteCars createState() => _FavouriteCars();
}

class _FavouriteCars extends State<FavouriteCars> {
  List<Filter> filters = getFilterList();
  late Filter selectedFilter;
  List<Car> cars = [];

  void fetchData(String clientId) async {
    List<Car> carList = await getFavCarList(clientId);
