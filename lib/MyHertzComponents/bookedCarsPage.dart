...
class BookedCarsPage extends StatefulWidget {
  @override
  _BookedCarsPage createState() => _BookedCarsPage();
}

class _BookedCarsPage extends State<BookedCarsPage> {
  List<Filter> filters = getFilterList();
  late Filter selectedFilter;
  List<Car> cars = [];

  void fetchData(String clientId) async {
    List<Car> carList = await getBookedCarList(clientId);
    setState(() {
      cars = carList;
    });
  }
