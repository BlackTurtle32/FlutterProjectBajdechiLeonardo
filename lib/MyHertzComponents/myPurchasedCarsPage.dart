...
class PurchasedCars extends StatefulWidget {
  @override
  _PurchasedCars createState() => _PurchasedCars();
}

class _PurchasedCars extends State<PurchasedCars> {
  List<Filter> filters = getFilterList();
  late Filter selectedFilter;
  List<Car> cars = [];

  void fetchData(String clientId) async {
    List<Car> carList = await getBoughtCarList(clientId);
